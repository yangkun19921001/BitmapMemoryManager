package com.yk.bitmap_memory_manager;
...
import com.yk.bitmap_memory_manager_library.ImageCache;
import com.yk.bitmap_memory_manager_library.ImageResize;
...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //第一次优化
//        Bitmap bitmap = ImageResize.resizeBitmap(context, R.mipmap.girl,
//                80, 80, false);
        ...
        if(null==bitmap){
            ...
            //如果磁盘中也没缓存,就从网络下载
            if(null==bitmap){
                bitmap= ImageResize.resizeBitmap(context,R.mipmap.girl,80,80,false,reuseable);
